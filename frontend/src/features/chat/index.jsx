    ...
    if (selectedFile) {
      ...
      try {
        ...
        const response = await axios.post(
          `${import.meta.env.VITE_BACKEND_URL || (import.meta.env.VITE_API_URL ? import.meta.env.VITE_API_URL.replace(/\/api\/v1\/?$/, '') : 'http://localhost:5000')}/api/v1/uploads/chat-attachment`,
          formData,
          {
            headers: {
