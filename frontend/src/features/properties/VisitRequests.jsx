...
import { Calendar, Clock, MapPin, Check, X, Info } from 'lucide-react';
...
const VisitRequests = () => {
  ...
  const { data: visits, isLoading, error, refetch } = useQuery({
    queryKey: ['properties', 'visits'],
    queryFn: () => propertyService.getVisits(),
  });
            ...
            return (
              <Card key={visit.id || visit._id} className="p-5 border-secondary-200/50 flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex flex-col md:flex-row gap-4 items-start md:items-center">
                  {/* Property mini thumbnail details */}
                ...
                {/* Counterparty avatar & Status actions */}
